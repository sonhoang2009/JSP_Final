...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
    ...
    <form action="/admin/product/creat" method="post" class="w3-container w3-card-4 w3-light-grey w3-text-blue w3-margin">
        ...
        <div class="w3-row w3-section">
            <div class="w3-col" style="width:50px"><i class="w3-xxlarge fa fa-picture-o" aria-hidden="true"></i>
            </div>
            <div class="w3-rest">
                <input class="w3-input w3-border" name="thumbnail" type="text" placeholder="Image">
            </div>
        </div>
